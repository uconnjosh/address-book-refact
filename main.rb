   ...
   Term.all.each do |term|
    i = 0
      ...
      if current_word == current_hash.keys[i]
        ...
        puts 'Press D to delete the entry, A to add a definition, and E to edit a definition. Pressing any other key will return you to the main menu!'
        ...
        when 'A'
          puts "Please type the definition you'd like to add to" + current_word +":"
          another_def = gets.chomp
          current_object.add_def(another_def)
          # current_object.definitions << new_def
        else
          main_menu
        end
